...
<form id="updateForm" action="${ pageContext.request.contextPath }/mUpdate.bo"  method="post"  >
		<div class="input-group mb-3" style="width:900px;">

			<br />
  				<input type="text" class="form-control" aria-label="Text input with dropdown button" 
 				 name="title" placeholder="제목을 입력하세요." value="${board.btitle}">
 				
		</div>

		<div class="editorArea"  style="margin-top:20px;">
  				<textarea id="summernote" name="editordata">${board.bcontent}</textarea>
		</div>
 ...
 var form_data = new FormData();
  ...
  function completeUpdate(){
   ...
   function deleteBoard(){
      ...
      if(answer == true){
    	  $('#updateForm').attr("action", "${pageContext.request.contextPath}/mDelete.bo");
        } 
   }
