...
.pagingArea{
	...
	<br /><br />
    <div id="yu" class="site-blocks-cover overlay aos-init aos-animate" style="background-image: url('${pageContext.request.contextPath}/resources/img/KBO.jpg;">
    </div>
	...
	<span class="badge badge-pill badge">KIA</span>
	<span class="badge badge-pill badge-light">한화</span>
