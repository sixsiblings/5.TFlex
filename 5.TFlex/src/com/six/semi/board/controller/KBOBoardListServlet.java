...
/**
 * Servlet implementation class KBOBoardListServlet
 */
@WebServlet("/kselectList.bo")
public class KBOBoardListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public KBOBoardListServlet() {
        super();
